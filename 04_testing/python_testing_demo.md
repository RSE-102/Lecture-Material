...
Example code is in [automation-lecture](https://github.com/RSE-102/automation-lecture).

## Software Code Used

The file [operations.py](https://github.com/RSE-102/automation-lecture/blob/main/operations.py) consists of a class `MathOperations` that has the following functions: `reorder_data`, `find_max`, `find_median`, and `find_mean`. The `main()` routine in the file applies the functions to a list and prints the output.
