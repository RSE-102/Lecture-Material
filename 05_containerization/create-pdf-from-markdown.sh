...
PANDOC_SLIDE_OPTIONS=("--pdf-engine=xelatex" "-t beamer" "-H listings_setup.tex" "-V aspectratio=169" "-V linkcolor:blue" "-V fontsize=12pt" "--listings" "-s")
...
do
    ...
    pandoc ${output_options} -f ${SOURCE_FORMAT} --output=${target_dir}/${output_filename} ${f}
